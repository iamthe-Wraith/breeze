...
func! s:clr(fg, bg, ...)
  let l:fg = g:breeze#palette[a:fg]
  let l:bg = g:breeze#palette[a:bg]
...
if get(g:, 'airline#extensions#tabline#enabled', 0)
  let g:airline#themes#breeze#palette.tabline = {
...
if exists('g:loaded_ctrlp')
  let g:airline#themes#breeze#palette.ctrlp = airline#extensions#ctrlp#generate_color_map(
        \ s:clr('fg', 'selection'),
        \ s:clr('fg', 'comment'),
        \ s:clr('fg', 'purple'),
        \)
